...
const Login = () => {
    const { t } = useLanguage();
    const tr = translations.loginPage;
    ...
    useEffect(() => {
        ...
        if (token) {
            ...
            if (errorMsg === 'Admin_Google_Forbidden') {
                setError(t(tr.adminForbidden));
            } else {
                setError(t({ fr: 'Échec de la connexion : ', ar: 'خطأ في الدخول: ' }) + errorMsg);
            }
        }
    }, [location, t, tr.adminForbidden]);
            ...
            <div className="login-container">
                <ScrollReveal direction="up" className="login-card visible">
                    ...
                    <div className="login-footer">
                        {t(tr.noAccount)} <Link to="/inscription">{t(tr.registerLink)}</Link>
                    </div>
                </ScrollReveal>
            </div>
        </div>
